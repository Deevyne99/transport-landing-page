...
const Customers = () => {
  return (
    <section className='pb-12'>
      <div className='flex flex-col   gap-4 xl:mx-48 lg:mx-8'>
        ...
        <div className='flex items-center mt-6'>
          <div className='w-1/2 bg-[#F4F4F4] h-[350px] flex flex-col p-12 gap-6'>
          ...
          <div className='w-1/2 bg-[#091242] h-[350px] flex flex-col p-12 gap-6'>
            <header className='flex items-center justify-between'>
              <div className='flex items-center gap-4'>
